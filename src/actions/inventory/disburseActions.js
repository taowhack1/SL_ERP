...
export const get_disburse_by_id =
  (disburse_id, user_name, redirect) => async (dispatch) => {
    try {
      if (user_name) {
...
export const create_disburse =
  (user_name, data_head, data_detail, redirect) => async (dispatch) => {
    ...
    temp_detail.map((detail) =>
      temp_sub_detail.push(detail.disburse_sub_detail)
    );
...
export const update_disburse =
  (disburse_id, user_name, data_head, data_detail, redirect) =>
  async (dispatch) => {
    let temp_sub_detail = [];
    let temp_detail = data_detail;
    temp_detail.map((detail) =>
...
export const filterDisburse = (data) => (dispatch) =>
  dispatch({ type: SEARCH_DISBURSE, payload: data });

export const reset_disburse = () => (dispatch) => {
