...
import { getItemTypeList } from "../../../../actions/inventory";
import { sortData } from "../../../../include/js/function_main";
import { get_item_type_in_row } from "../../../../actions/inventory/configurations/type/typeItemAction";
              ...
              onRow={(record, rowIndex) => {
                return {
                  onClick: (e) => {
                    ...
                    dispatch(get_item_type_in_row(record));
                    props.history.push({
                      pathname:
