...
const SalesOrdersSearch = ({
    ...
    useEffect(() => {
        const savedFilters = localStorage.getItem("salesOrdersSearchFilters")
        if (savedFilters) {
            try {
    ...
    useEffect(() => {
        localStorage.setItem("salesOrdersSearchFilters", JSON.stringify(filters))
    }, [filters])
    ...
    const clearFilters = () => {
        ...
        localStorage.removeItem("salesOrdersSearchFilters")
...
export default SalesOrdersSearch
