                ...
                <Row className='col-2 row-margin-vertical'>
                  <Col span={12}>
                    ...
                    <Row className='row-margin'>
                      ...
                      <Col span={18}>
                        <Text strong>{data_head.customer_phone}</Text>
                      </Col>
                      <Col span={1}></Col>
                    </Row>
                    <Row className='row-margin'>
                      ...
                      <Col span={18}>
                        <Text strong>{data_head.customer_mobile}</Text>
                      </Col>
                      <Col span={1}></Col>
                    </Row>
                    <Row className='row-margin'>
                      ...
                      <Col span={18}>
                        <Text strong>{data_head.customer_email}</Text>
                      </Col>
                      <Col span={1}></Col>
                    </Row>
                    <Row className='row-margin'>
                      ...
                      <Col span={18}>
                        <Text strong>{data_head.customer_category_name}</Text>
                      </Col>
                      <Col span={1}></Col>
                    </Row>
                    <Row className='row-margin'>
