...
const SummarySo = () => {
  ...
  const config = {
    ...
    show: true,
    breadcrumb: ["Home", "Reporting", "Summary SO"],
    search: false,
    create: "",
    buttonAction: "",
    edit: {},
  ...
  const showReport = (formButton) => {
    const report_user_action = `${process.env.REACT_APP_REPORT_SERVER}/report_so_sum_by_date.aspx?report_type=1&user_name=${user_name}`;
