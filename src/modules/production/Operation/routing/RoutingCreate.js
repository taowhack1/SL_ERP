        ...
        <Row className='col-2 mt-2' gutter={[32, 0]}>
          ...
          <Col span={12} className='col-border-right'>
            ...
            <Row className='col-2 row-margin-vertical'>
              ...
              <Col span={12}>
                <Input
                  disabled={dataHead.item_id ? false : true}
                  readOnly
                  value={dataHead.item_no_name_ref}
                  name='item_id_ref'
                  placeholder={"Bulk Item"}></Input>
              </Col>
            </Row>
            <Row className='col-2 row-margin-vertical'>
              <Col span={6}>
              ...
              <Col span={12}>
                <Input
                  ...
                  placeholder={"Working time Min"}></Input>
              </Col>
            </Row>
            <Row className='col-2 row-margin-vertical'>
              <Col span={6}>
              ...
              <Col span={12}>
                <Input
                  ...
                  placeholder={"Working time Hour"}></Input>
              </Col>
            </Row>
            <Row className='col-2 row-margin-vertical'>
              <Col span={6}>
              ...
              <Col span={12}>
                <Input
                  ...
                  placeholder={"Working time Day"}></Input>
              </Col>
            </Row>
          </Col>
          {/* right */}
