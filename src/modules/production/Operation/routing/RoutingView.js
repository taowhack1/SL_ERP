      ...
      <div id='form'>
        ...
        <Row className='col-2 row-tab-margin'>
          <Col span={24} style={{ marginBottom: 8 }}>
            ...
            <Col span={12}>
              <Text className='text-view'>{data_head.routing_remark}</Text>
            </Col>
          </Col>
        </Row>
        <Row className='col-2 mt-2' gutter={[32, 0]}>
          ...
          <Col span={12} className='col-border-right'>
            ...
            <Row className='col-2 row-margin-vertical'>
              ...
              <Col span={12}>
                <Text> {data_head.routing_working_time_min}</Text>
              </Col>
            </Row>
            <Row className='col-2 row-margin-vertical'>
              <Col span={6}>
              ...
              <Col span={12}>
                <Text>{data_head.routing_working_time_hour}</Text>
              </Col>
            </Row>
            <Row className='col-2 row-margin-vertical'>
              <Col span={6}>
              ...
              <Col span={12}>
                <Text>{data_head.routing_working_time_day} </Text>
              </Col>
            </Row>
          </Col>
          {/* right */}
          <Col span={12}>
            <Row className='col-2 row-margin-vertical'>
              ...
              <Col span={8}>
                <Text>{data_head.routing_batch_size}</Text>
              </Col>
            </Row>
            <Row className='col-2 row-margin-vertical'>
              <Col span={6}>
              ...
              <Col span={8}>
                <Text>{data_head.routing_fill_weight}</Text>
              </Col>
            </Row>
            <Row className='col-2 row-margin-vertical'>
              <Col span={6}>
              ...
              <Col span={8}>
                <Text>{data_head.routing_pack_size}</Text>
              </Col>
            </Row>
            <Row className='col-2 row-margin-vertical'>
              <Col span={6}>
            ...
            <Row className='col-2 row-margin-vertical'>
              ...
              <Col span={8}>
                <Text>{data_head.routing_capacity_min}</Text>
              </Col>
            </Row>
            <Row className='col-2 row-margin-vertical'>
              <Col span={6}>
              ...
              <Col span={8}>
                <Text>{data_head.routing_worker_hour}</Text>
              </Col>
            </Row>
          </Col>
        </Row>
