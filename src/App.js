...
import SettingsIndex from "./modules/settings/SettingIndex";
import LineMain from "./modules/settings/Notification/Line/LineMain";
      ...
      <BrowserRouter>
        <AppContext.Provider value={AppContextValue}>
          <Switch>
            ...
            <Route
              exact
              path='/setting/notifications/line'
              component={LineMain}
            />
            <Route>
              <NotFound />
